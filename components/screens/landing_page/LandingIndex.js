...
import { GridCard, ListCard, SquareCard, WhiteCard } from '../../custom_components/customCards'
...
const LandingIndex = (props) => {
    ...
    const dealers = [
        {id:'1',url:require('../../../assets/images/bm2.jpg'),name:'Lorem Ipsum',deals:503},
        {id:'2',url:require('../../../assets/images/bm3.png'),name:'Johnny Cage',deals:393},
        {id:'3',url:require('../../../assets/images/car3.jpg'),name:'Sky Maviricks',deals:295},
